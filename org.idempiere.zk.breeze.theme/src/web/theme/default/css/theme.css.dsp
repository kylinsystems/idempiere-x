...
/* Alibaba PuHuiTi 3.0 - 55 Regular GB18030-2022 */
@font-face {
  font-display: swap;
...
html,body {
	...
	color: #333;
	font-family: -apple-system, BlinkMacSystemFont, 'AlibabaPuHuiTi-3-55-Regular', 'Noto Sans SC', 'Noto Serif SC', 'Microsoft Yahei', 'Noto Sans SC', 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;
	overflow: hidden;
}
